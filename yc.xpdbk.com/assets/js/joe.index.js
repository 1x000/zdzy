                    ...
                    <li class="joe_list__item wow default">
                        ...
                        <div class="information">
                            <a href="${_.permalink}" class="title" title="${_.title}" target="${_.target}" rel="noopener noreferrer">
                                <span class="badge" style="display: ${_.type === 'sticky' ? 'inline-block' : 'none'}">ປັກໝຸດເທິງ</span>${_.title}
                            </a>
                            <a class="abstract" href="${_.permalink}" title="ບົດຄັດຫຍໍ້" target="${_.target}" rel="noopener noreferrer">${_.abstract}</a>
                            <div class="meta">
                                <ul class="items">
                                    <li>${_.created}</li>
                                    <li>${_.views} ອ່ານ</li>
                                    <li>${_.commentsNum} ຄໍາເຫັນ</li>
                                    <li>${_.agree} ມັກ</li>
                                </ul>
				...
				$.ajax({
					...
					success(res) {
						...
						if (res.data.length === 0) {
							...
							$('.joe_load').hide();
							$('.joe_load').html('ເບິ່ງເພີ່ມເຕີມ');
							return Qmsg.warning('ບໍ່ມີເນື້ອຫາເພີ່ມເຕີມ');
						}
